                    ...
                    <?php foreach ($bidang as $row) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn icon btn-lg btn-danger" id="btnDelete" data-id="<?= base_url('admin/kelola-bidang/delete/' . $row['id']); ?>"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
...
<div class="modal fade text-left" id="modalCreate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kelola-bidang/store') ?>" method="POST">
                <?= csrf_field(); ?>
...
<div class="modal fade text-left" id="modalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kelola-bidang/update') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="modal-body">
...
<script>
    $('body').on('click', '#btnEdit', function() {
        ...
        $.ajax({
            type: "GET",
            url: "<?= base_url('admin/kelola-bidang/edit'); ?>",
            data: {
                id: this_id,
            },
