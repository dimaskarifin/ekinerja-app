...
<section class="section">
    <div class="card">
        <div class="card-header">
            <a class="btn icon icon-left btn-primary" data-bs-target="#modalCreate" data-bs-toggle="modal"><i data-feather="edit"></i> Tambah Data Pengguna</a>
        </div>
        <div class="card-body">
                    ...
                    <?php foreach ($users as $key => $val) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn icon btn-lg btn-danger" id="btnDelete" data-id="<?= base_url('admin/kelola-pengguna/delete/' . $val->id_users); ?>"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
...
<div class="modal fade text-left" id="modalCreate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kelola-pengguna/store') ?>" method="POST" enctype="multipart/form-data" files="true">
                <?= csrf_field() ?>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input id="addTempatLahir" name="tempat_lahir" type="text" placeholder="Masukkan tempat lahir" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label>Tanggal Lahir <span class="text-danger">*</span></label>
                            <div class="form-group">
                                <input id="addTanggalLahir" name="tanggal_lahir" type="date" placeholder="Masukkan tanggal lahir" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input id="confirm_password" name="confirm_password" type="password" placeholder="Masukkan Konfirmasi Password" class="form-control" required>
...
<div class="modal fade text-left" id="modalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kelola-pengguna/update') ?>" method="POST" enctype="multipart/form-data" files="true">
                <?= csrf_field() ?>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label>Tempat lahir <span class="text-danger">*</span></label>
                            <div class="form-group">
                                <input id="editTempatLahir" name="tempat_lahir" type="text" placeholder="Masukkan Tempat lahir" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label>Tanggal lahir <span class="text-danger">*</span></label>
                            <div class="form-group">
                                <input id="editTanggalLahir" name="tanggal_lahir" type="date" placeholder="Masukkan Tempat lahir" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label for="">Alamat <span class="text-danger">*</span></label>
                            <textarea class="form-control" name="alamat" rows="3" placeholder="Masukkan Alamat" id="editAlamat"></textarea>
                        </div>
                        <div class="col-md-6">
                            <label>Password <span class="text-danger">*</span></label>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <label>Confirm Password <span class="text-danger">*</span></label>
                            <div class="form-group">
                                <input id="editConfirm" name="confirm_password" type="password" placeholder="Masukkan Konfirmasi Password" class="form-control">
