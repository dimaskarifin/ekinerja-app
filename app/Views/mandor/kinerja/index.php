                    ...
                    <?php foreach ($ekinerja as $key => $val) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn icon btn-lg btn-danger" id="btnDelete" data-id="<?= base_url('mandor/kelola-ekinerja/delete/' . $val->id_ekinerja); ?>"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
...
<div class="modal fade text-left" id="modalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('mandor/kelola-ekinerja/update') ?>" method="POST">
                <?= csrf_field() ?>
...
<script>
    ...
    $('body').on('click', '#btnEdit', function() {
        ...
        $.ajax({
            type: "GET",
            url: "<?= base_url('mandor/kelola-ekinerja/edit'); ?>",
            data: {
                id: this_id,
            },
