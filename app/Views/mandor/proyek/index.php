                ...
                <tbody>
                    ...
                    <?php foreach ($proyek as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($row['tukang_id'] === null) : ?>
                                    <a class="btn icon btn-lg btn-warning" id="btnEdit" data-id="<?= $row->proyek_id ?>"><i class="bi bi-pencil-square"></i>Tukang</a>
                                    <?php break; ?>
                                <?php endif; ?>
                                <a class="btn icon btn-lg btn-danger" id="btnDelete" data-id="<?= base_url('mandor/kelola-proyek/delete/' . $row->proyek_id); ?>"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
