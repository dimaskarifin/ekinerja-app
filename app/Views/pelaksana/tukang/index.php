    ...
    <div class="card">
        <div class="card-header">
            <a class="btn icon icon-left btn-primary" data-bs-target="#modalCreate" data-bs-toggle="modal"><i
                    data-feather="edit"></i> Tambah Data Tukang</a>
        </div>
        <div class="card-body">
            <table class="table" id="table1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="btn icon btn-lg btn-warning" id="btnEdit" data-id="<?= $val->id ?>"><i
                                    class="bi bi-pencil-square"></i></a>
                            <a href="#" class="btn icon btn-lg btn-danger" id="btnDelete"
                                data-id="<?= base_url('pemilik/users/delete/' . $val->id); ?>"><i
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('pemilik/users/update') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <label>Username</label>
                    <div class="form-group">
                        <input id="editUsername" name="username" type="text" placeholder="Username"
                            class="form-control" />
                    </div>
                    <label for="password">Kata Sandi: </label>
                    <div class="form-group">
                        <input type="password" id="editPassword" name="password" placeholder="Masukkan Kata Sandi Baru"
                            class="form-control" required />
                    </div>
                    <label>Role User: </label>
                    <div class="form-group">
                        <input id="editRole" name="role" type="text" placeholder="Role User" class="form-control"
                            value="admin" readonly />
                    </div>
                </div>
                <div class="modal-footer">
